...
/>
      ...
      <div className="flex max-h-full min-h-full flex-1 flex-col items-center justify-between relative top-32 right-24 space-y-6">
        <button className="flex items-center justify-between rounded-xl bg-primary bg-opacity-20 p-3 px-0 text-2xl text-primary duration-300 hover:bg-opacity-70 hover:text-back bg-[#7afaa5] hover:bg-[#63ba82] "
        >
          <img
            ...
            className="w-[25%]"
          />
          <h3 className="font-raleway font-semibold tracking-tight relative right-40">
            Request Claim
          </h3>
        </button>
        <button className="relative flex items-center justify-between rounded-xl bg-secondary bg-opacity-20 p-3 px-0 text-2xl text-secondary duration-300 hover:bg-opacity-70 hover:text-back bg-[#f3c259] hover:bg-[#ebab2d]">
          ...
          <h3 className="font-raleway font-semibold tracking-tight relative right-36">
            Add
          </h3>
        </button>
